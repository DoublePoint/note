<template>
  <div v-if="!item.hidden">
    <div @contextmenu.stop.prevent="rightClick($event)" @click.stop="handldSelect">
...
export default {
  ...
  methods: {
    ...
    rightClick(e) {
      ...
      this.$store.commit('changeMouseTopNumber', e.pageY)
      this.$store.commit('changeMouseLeftNumber', e.pageX)
